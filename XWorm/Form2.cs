...
;
    ...
    {
        this.Hide();                                               // Hide activation
        XWorm.Builder builder = new XWorm.Builder();               // Full name, no using needed
        builder.ShowDialog();                                      // Open Builder panel
        this.Close();                                              // Kill activation

        // Original code (won't run anyway)
